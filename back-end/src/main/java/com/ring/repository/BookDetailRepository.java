...
/**
 * Repository interface named {@link BookDetailRepository} for managing
 * {@link BookDetail} entities.
 */
@Repository
public interface BookDetailRepository extends JpaRepository<BookDetail, Long> {
     ...
     *
     * @param id   the ID of the book to retrieve details for; optional if slug is
     *             provided.
     * @param slug the slug identifier of the book to retrieve details for; optional
     *             if ID is provided.
     * @return an {@code Optional} containing the details of the book AS an
     *         {@code IBookDetail}
     *         projection, or an empty {@code Optional} if no book matches the
     *         specified criteria.
     */
    @Query("""
     ...
     * @param userId the ID of the user to check for the book.
     * @return an {@link Optional} containing the book information represented by
     *         {@code IBook},
     *         or an empty {@link Optional} if no book matches the provided
     *         identifier
     */
    @Query("""
                SELECT DISTINCT b.id AS id,
            ...
            """)
    Optional<IBook> findBook(Long id, Long userId);
}

...
/**
 * Repository interface named {@link AccountRepository} for managing
...
public interface AccountRepository extends JpaRepository<Account, Long> {
     ...
     * @return an Optional containing the Account entity if found, or an empty
     ...
     * @return an {@code Optional} containing the account if found, or an empty
    ...
    /**
     * Retrieves an optional {@link Account} entity based on the specified refresh
     * token and username.
     * The query joins the associated roles and refresh tokens to fetch the account
     * details.
     *
     ...
     * @return an {@code Optional} containing the account if found, or
    ...
    /**
     * Retrieves analytics data for accounts, including total accounts created in
     * the last two months,
     * accounts created in the current month, and accounts created in the previous
     * month.
     *
     * @return an IStat projection object containing the total number of accounts,
     *         the count of accounts
     *         created in the current month, and the count of accounts created in
     *         the previous month.
     */
    @Query("""
     ...
     *
     * @param keyword  the search keyword used to filter accounts by their email or
     *                 username
     * @param role     the user role used to filter accounts; if null, this filter
     *                 is ignored
     * @param pageable pagination information to limit and sort the results
     * @return a page of projections containing account information, including ID,
     *         username, email, profile name, phone, roles, and associated image
     */
    @Query("""

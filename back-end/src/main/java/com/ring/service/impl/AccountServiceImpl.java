...
public class AccountServiceImpl implements AccountService {
    ...
    public Account saveAccount(AccountRequest request, MultipartFile file) {
        ...
        profile = this.changeProfilePic(file, request.getRemoveImage(), profile);
     ...
     * picture.
     *
     * @param file        the new image file to be uploaded as the profile picture,
     *                    can
     *                    be null for removing the image
     * @param removeImage true if the image should be removed, false otherwise
     * @param profile     the account profile to be updated
     * @return the updated account profile with the modified profile picture
     */
    protected AccountProfile changeProfilePic(MultipartFile file, Boolean removeImage, AccountProfile profile) {

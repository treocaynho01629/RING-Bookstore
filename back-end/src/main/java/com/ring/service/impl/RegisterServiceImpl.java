...
public class RegisterServiceImpl implements RegisterService {
    ...
    public Account register(RegisterRequest registerRequest, HttpServletRequest request) {
        ...
        captchaService.validate(captchaToken, source, CaptchaServiceImpl.REGISTER_ACTION);
    ...
    public void forgotPassword(String email, HttpServletRequest request) {
        ...
        final String captchaToken = request.getHeader(AppConstants.HEADER_RESPONSE);
        final String source = request.getHeader(AppConstants.HEADER_CAPTCHA_SOURCE);
        captchaService.validate(captchaToken, source, CaptchaServiceImpl.FORGOT_ACTION);
    ...
    public Account resetPassword(String token, ResetPassRequest resetRequest, HttpServletRequest request) {
        ...
        final String captchaToken = request.getHeader(AppConstants.HEADER_RESPONSE);
        final String source = request.getHeader(AppConstants.HEADER_CAPTCHA_SOURCE);
        captchaService.validate(captchaToken, source, CaptchaServiceImpl.RESET_ACTION);
